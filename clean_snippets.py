#!/usr/bin/env python3
"""
Clean up snippets in crypto_snippets_150.xlsx to make them readable.
...
INPUT_FILE = pathlib.Path("crypto_snippets_150.xlsx")
OUTPUT_FILE = pathlib.Path("crypto_snippets_150_cleaned.xlsx")
